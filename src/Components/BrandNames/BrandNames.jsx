...
const BrandNames = () => {
    ...
    return (
        <div className="pt-16 bg-green-100 ">
           <h2 className="font-bold  bg-green-100 text-green-500  text-5xl text-center mt-16 py-5 mb-10 border-2 border-green-300">Popular Brand Products</h2> 
