...
const Footer = () => {
    return (
        <div>
            <footer className="footer footer-center p-10  text-primary-content bg-green-100 border-2 border-green-600">
                <aside className="text-black">
                    ...
                    <p className="font-bold text-black">
                        TechLand Ltd. <br />Providing reliable tech services since 2005
                    </p>
